          ...
          <template slot-scope="scope">
            <el-dropdown size="medium" >
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item @click.native.prevent="getRoleBindingYaml(scope.row.namespace, scope.row.name, scope.row.kind)">
                  <svg-icon style="width: 1.3em; height: 1.3em; line-height: 40px; vertical-align: -0.25em" icon-class="edit" />
                  <span style="margin-left: 5px;">修改</span>
                </el-dropdown-item>
                <el-dropdown-item @click.native.prevent="deleteRoleBindings([{namespace: scope.row.namespace, name: scope.row.name}])">
